...
sampled_df1 = df.sample(n=50000, random_state=1)
...
#sampled_df2 = remaining_df.sample(n=200000, random_state=2)
...
concatenated_df1.to_csv("../../Downloads/historical_stock_prices.csv/merged_data_50.csv", index=False)
...
#concatenated_df2.to_csv("../../Downloads/historical_stock_prices.csv/merged_data_100.csv", index=False)